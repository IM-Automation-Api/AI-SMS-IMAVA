...
export default function OnboardingPage() {
  ...
  useEffect(() => {
    const checkOnboardingStatus = async () => {
      try {
        // Small timeout to avoid flickering for fast connections
    ...
    <div className="space-y-6">
      ...
      <div className="w-full">
        ...
        {organizationName.length > 2 && subdomainAvailable && (
          <div className="bg-green-100 dark:bg-green-900/30 border border-green-200 dark:border-green-700 text-green-800 dark:text-green-300 text-sm rounded-md p-2 mt-2 flex items-center font-mono">
