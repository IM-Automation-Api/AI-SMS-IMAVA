      ...
      <div className="flex min-h-screen items-center justify-center p-4">
        <Card className="w-full max-w-md bg-card/70 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <Button variant="outline" type="button" disabled={isGoogleLoading} onClick={handleGoogleSignIn} className="w-full flex items-center justify-center gap-2 font-mono">
            ...
            {loginError && <div className="p-3 text-sm bg-red-50 text-red-600 rounded-md font-mono">
                {loginError}
              </div>}
            ...
            <Form {...form}>
              <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4">
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="name@company.com" type="email" {...field} autoComplete="email" className="font-mono" />
                      </FormControl>
                ...
                field
                      ...
                      <FormControl>
                        <Input placeholder="••••••••" type="password" {...field} autoComplete="current-password" className="font-mono" />
                      </FormControl>
                      <FormMessage className="font-mono" />
                    </FormItem>} />
                ...
                <Button type="submit" className="w-full font-mono" disabled={isLoading} data-testid="login-button">
